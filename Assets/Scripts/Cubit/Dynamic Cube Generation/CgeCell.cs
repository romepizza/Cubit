...
public class CgeCell
{
    ...
    public void moveAndScanCell(Vector3 direction)
    {
        ...
        //Debug.Log("A: " + Vector3.Angle(direction, (m_center - m_player.transform.position).normalized) + ", D: " + Vector3.Dot(direction.normalized, m_normal.normalized));
        //Debug.Log("Dot: " + Vector3.Dot(direction.normalized, (m_center - m_player.transform.position).normalized));// +"D: " + direction.normalized + "N: " + m_normal.normalized);
        //if (Vector3.Dot(direction, m_center) >= 0f)
