...
public class SkillGather : MonoBehaviour
{
    ...
    void activateSkill()
    {
        ...
        if (GameObject.Find("LogInformationObject") != null && GameObject.Find("LogInformationObject").GetComponent<Log>() != null)
            GameObject.Find("LogInformationObject").GetComponent<Log>().logRegisterSkillGather(grabbed, GetComponent<GrabSystem>().grabbedCubes.Count);
        else if (GameObject.Find("GeneralScriptObject").GetComponent<Log>())
            GameObject.Find("GeneralScriptObject").GetComponent<Log>().logRegisterSkillGather(grabbed, GetComponent<GrabSystem>().grabbedCubes.Count);
    }
