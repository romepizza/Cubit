...
public class MonsterEntitySkillDrone : EntityCopiableAbstract
{
    ...
    void createDrone()
    {
        ...
        m_chosenCube.GetComponent<MonsterEntityBase>().m_target = PlayerEntityAim.aim();
    }
    ...
    void changeTarget(GameObject target)
    {
        ...
        {
            drone.GetComponent<MonsterEntityBase>().m_target = target;
        }
    }
    // copy
