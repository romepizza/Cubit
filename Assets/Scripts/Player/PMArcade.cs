...
public class PMArcade : MonoBehaviour
{
    ...
    {
        if (playerRotationScript.isPressingButtonLeft || playerRotationScript.isPressingButtonRight)
        {
        ...
        if (isPressingButtonUp || isPressingButtonDown)
        {
        ...
        if (playerRotationScript.isPressingButtonForward || playerRotationScript.isPressingButtonBackward)
        {
    ...
    {
        forceMovementVectorTotal =  (transform.rotation * forceMovementVectorX + transform.rotation * forceMovementVectorY + playerCamera.transform.rotation * forceMovementVectorZ);
